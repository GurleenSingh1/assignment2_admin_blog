    ...
    var methods = {
        ...
        */
        ...
        _buildPrompt: function(field, promptText, type, ajaxed, options) {
            ...
            var promptContent = $('<div>').addClass("formErrorContent").php(promptText).appendTo(prompt);
            ...
            if (options.showArrow) {
                ...
                switch (options.promptPosition) {
                    ...
                    case "bottomRight":
                        ...
                        arrow.addClass("formErrorArrowBottom").php('<div class="line1"><!-- --></div><div class="line2"><!-- --></div><div class="line3"><!-- --></div><div class="line4"><!-- --></div><div class="line5"><!-- --></div><div class="line6"><!-- --></div><div class="line7"><!-- --></div><div class="line8"><!-- --></div><div class="line9"><!-- --></div><div class="line10"><!-- --></div>');
                        break;
                    case "topLeft":
                    case "topRight":
                        arrow.php('<div class="line10"><!-- --></div><div class="line9"><!-- --></div><div class="line8"><!-- --></div><div class="line7"><!-- --></div><div class="line6"><!-- --></div><div class="line5"><!-- --></div><div class="line4"><!-- --></div><div class="line3"><!-- --></div><div class="line2"><!-- --></div><div class="line1"><!-- --></div>');
                        prompt.append(arrow);
                        break;
                }
            }
        ...
        _updatePrompt: function(field, prompt, promptText, type, ajaxed, options) {
            ...
            if (prompt) {
                ...
                prompt.find(".formErrorContent").php(promptText);
